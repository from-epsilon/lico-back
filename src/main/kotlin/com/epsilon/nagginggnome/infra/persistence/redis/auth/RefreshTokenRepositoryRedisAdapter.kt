package com.epsilon.nagginggnome.infra.persistence.redis.auth

import com.epsilon.nagginggnome.domain.auth.repository.RefreshTokenRepository
import com.epsilon.nagginggnome.infra.persistence.redis.config.RedisKeyPrefix
 ...
 */
@Repository
class RefreshTokenRepositoryRedisAdapter(
